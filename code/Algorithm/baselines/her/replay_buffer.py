...
class ReplayBuffer:
    ...
    def sample(self, batch_size):
        ...
        transitions,weights = self.sample_transitions(buffers, batch_size)
...
class ReplayBufferEntropy:
    ...
    def fit_density_model(self):
        ...
        self.clf = mixture.BayesianGaussianMixture(weight_concentration_prior_type="dirichlet_distribution",
                                                   n_components=3)

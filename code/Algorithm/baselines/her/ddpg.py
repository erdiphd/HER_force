...
class DDPG(object):
    ...
    def __init__(self, input_dims, buffer_size, hidden, layers, network_class, polyak, batch_size,
                 ...
                 sample_transitions, gamma, prioritization, reuse=False, **kwargs):
    ...
    def _preprocess_og(self, o, ag, g):
        if self.relative_goals:
            ...
            g = g.reshape(*g_shape)
        # print('before clipping: {}'.format(o))
        o = np.clip(o, -self.clip_obs, self.clip_obs)
        # print('after clipping: {}'.format(o))
    ...
    def store_episode(self, episode_batch, update_stats=True):
        ...
        if update_stats:
            ...
            transitions, weights = self.sample_transitions(episode_batch, num_normalizing_transitions)
    ...
    def sample_batch(self):
        if self.prioritization in ["force","work" ,"contact_energy"]:
            transitions, weights = self.buffer.sample(self.batch_size)
        else:
            transitions, weights = self.buffer.sample(self.batch_size)

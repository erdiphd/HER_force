...
MODEL_XML_PATH = os.path.join('fetch', 'frankapick_and_place.xml')
...
class FrankaPickAndPlaceEnv(franka_fetch_env.FetchEnv, utils.EzPickle):
    def __init__(self, reward_type='sparse'):
        ...
        franka_fetch_env.FetchEnv.__init__(
            ...
            gripper_extra_height=0.2, target_in_the_air=True, target_offset=0.0, task="frankapickandplace",force_range=10, force_reward_weight=0.25,
